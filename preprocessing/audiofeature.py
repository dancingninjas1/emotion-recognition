...
class AudioEmotionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Handle the error here, you can print an error message or raise an exception.
...
audio_dataset = AudioEmotionDataset('C:/Users/apurv/Desktop/project/Data/piano',
                                    'C:/Users/apurv/Desktop/project/Data/piano/annotations_piano.csv',
